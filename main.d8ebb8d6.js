...
function convertToNewString(string) {
  var newWord = "".concat(string.slice(0, -4)) + ' ' + 'name';
  var newName = newWord;
  return newName;
}
...
var listOfInputs = _toConsumableArray(inputs);

var _iterator = _createForOfIteratorHelper(listOfInputs),
    _step;
...
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    ...
    if (input.name.includes('Name')) {
      ...
      var capWord = capitalize(input.name);
